...
public class Day4Part1 {
    public static void main(String[] args) throws IOException {
        List<String> lines = Files.readAllLines((Paths.get("C:\\Users\\patry\\IdeaProjects\\AOC\\src\\advent_of_code\\day4\\day4part1data")));
        ...
        for (String line : lines) { //24-48,48-72
            ...
            if ((firstElfAssignments[0] <= secondElfAssignments[0] && firstElfAssignments[1] >= secondElfAssignments[1])
                    || (firstElfAssignments[1] <= secondElfAssignments[1] && firstElfAssignments[0] >= secondElfAssignments[0])) {
